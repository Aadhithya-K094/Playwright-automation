...
test('/api/RCDistList', async ({ request }) => {
    ...
    const response1 = await request.get("https://tng2c1.tnschools.gov.in/api/RCDistList");
...
test('/api/RcAppType', async ({ request }) => {
    ...
    const response2 = await request.get("https://tng2c1.tnschools.gov.in/api/RcAppType");
...
test('/api/RCLog?appid={id}', async ({ request }) => {
    ...
    const response3 = await request.get("https://tng2c1.tnschools.gov.in/api/RCLog?appid=1");
...
test('/api/Claslist', async ({ request }) => {
    ...
    const response3 = await request.get("https://tng2c1.tnschools.gov.in/api/Claslist");
    console.log(await response3.json());
    expect(response3.status()).toBe(200)
})
...
test('/api/rc_app_list', async ({ request }) => {
    ...
    const responsepost1 = await request.post('https://tng2c1.tnschools.gov.in/api/rc_app_list', {
        data: {
            "app_type": "",
            "app_status": "",
            "current_stage": "38-",
...
test('/api/rc_app_data', async ({ request }) => {
    ...
    const responsepost2 = await request.post('https://tng2c1.tnschools.gov.in/api/rc_app_data', {
        data: {
            "app_id": "300000312"
        },
        headers: { 'Accept': 'application/json' }
...
test('/api/rc_curstage_update', async ({ request }) => {
    ...
    const responsepost3 = await request.post('https://tng2c1.tnschools.gov.in/api/rc_curstage_update', {
        data: {
...
test('/api/rc_applctn_search', async ({ request }) => {
    ...
    const responsepost4 = await request.post('https://tng2c1.tnschools.gov.in/api/rc_applctn_search', {
        data: {
        },
...
test('/api/rc_preview', async ({ request }) => {
    ...
    const responsepost5 = await request.post('https://tng2c1.tnschools.gov.in/api/rc_preview', {
        data: {
            "app_id": "300000312"
        },
        headers: { 'Accept': 'application/json' }
...
test('/api/RCInfoByAppID', async ({ request }) => {
    ...
    const responsepost6 = await request.post('https://tng2c1.tnschools.gov.in/api/RCInfoByAppID',
        {
...
test
 ...
 ('/api/RCGrantUpdte', async ({ request }) => {

    const responsepost7 = await request.post('https://tng2c1.tnschools.gov.in/api/RCGrantUpdte', {
        data: {
        },
        headers: { 'Accept': 'application/json/json' }
    });
...
test('/api/save_recommendations', async ({ request }) => {
    ...
    const responsepost8= await request.post('https://tng2c1.tnschools.gov.in/api/save_recommendations', {
        data: {
        },
        headers: { 'Accept': 'application/json/json' }
    });
